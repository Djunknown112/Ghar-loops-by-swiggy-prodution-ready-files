        ...
        {isAiLoading ? (
          ...
          <p className="text-xs font-bold text-slate-700 leading-relaxed">
            {schedules.length === 0 
              ...
              : (aiInsight || "Bundle your weekly groceries on Swiggy Instamart to save on delivery fees.")}
          </p>
        )}

        <div className="mt-3.5 pt-3.5 border-t border-slate-100/60 flex items-center justify-between">
          <span className="text-[10px] text-slate-400 font-bold">Powered by Gemini 3.5 Flash</span>
          <button
            onClick={onRunAgent}
