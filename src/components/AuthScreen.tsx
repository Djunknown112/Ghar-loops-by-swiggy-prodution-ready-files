  ...
  return (
    <div className="flex flex-col min-h-[750px] justify-between p-6 bg-[#FAF8F5] relative select-none">
      ...
      <div className="text-center pt-8 space-y-4">
        {/* Logo/Icon block */}
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-3xl bg-[#FC8019] text-white shadow-md shadow-[#FC8019]/20 animate-pulse">
        ...
        <div>
          <h1 className="text-3xl font-black text-slate-800 tracking-tight flex items-center justify-center gap-1.5">
            Ghar<span className="text-[#FC8019]">Loop</span>
          </h1>
          <p className="text-xs text-slate-400 font-bold tracking-wider uppercase mt-1">
            Household Reorder Loop Automation
          </p>
        </div>
        ...
        {authMode === "options" && (
          <div className="space-y-3.5">
            <div className="text-center pb-2">
              <h2 className="text-sm font-bold text-slate-700">Select Sign-In Method</h2>
              <p className="text-[11px] text-slate-400 mt-0.5">Continuous auto-order security gate</p>
            </div>
      ...
      {/* Sandbox/Guest Mode Continue footer */}
      <div className="text-center pt-2 pb-6 space-y-3">
        <div className="text-[10px] text-slate-400 font-bold flex items-center justify-center gap-1.5">
          ...
          <span>AES-256 Cloud Authentication Sandbox</span>
        </div>
        ...
        >
          Continue as Guest (Skip Auth Gate)
        </button>
      </div>
    </div>
  );
